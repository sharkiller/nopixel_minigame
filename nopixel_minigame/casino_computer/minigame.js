...
let getMaxStreakFromCookie = () => {
    let str = getCookieValue('max-streak_casino_computer');
    if(str !== '')
...
let getBestTimeFromCookie = () => {
    let str = getCookieValue('best-time_casino_computer');
    if(str !== '')
